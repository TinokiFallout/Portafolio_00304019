...
int main() {
	...
	do {
		...
		case 3:
			...
			break;
		case 4:
			cout << "La cantidad de nodos es: " << cantidadArbol(arbol) << endl;
			break;
		case 5:
			cout << "La suma total de todos los nodos es: " << sumaArbol(arbol) << endl;
			break;
