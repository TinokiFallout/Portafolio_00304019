...
void mostrarListaCienciaFiccion(){
	Nodo *s = pInicio;
...
int main(){
    ...
    do{
        int opcion = 0;
        cout << "Menu: \n\t1) Agregar Libro\n\t2) Ver Libros \n\t3) Ver libros en español"
            << "\n\t4) Eliminar libro\n\t5) Buscar Libro \n\t6) Ver libros de ciencia ficcion"
        ...
        switch(opcion){
            ...
            case 6: cout << "Listando..." << endl;
                mostrarListaCienciaFiccion();
                break;
            case 7: cout << "Eliminando..." << endl;
                //for(int i=0;i<hack;i++){
                    eliminarLibroDeMisterio();
                break;
